            ...
            parallel {
                stage('build_x86_64_packages_Ubuntu_20.04') {
                    ...
                    steps {
                        ...
                        sh "podman run -it --rm -v /nfs/ubuntu2004:/root/debbuild ubuntu_20.04_build 4 Ubuntu 20.04"
                        sh "podman run -it --rm -v /nfs/ubuntu2004:/root/debbuild ubuntu_20.04_build 5 Ubuntu 20.04"
                        sh "podman run -it --rm -v /nfs/ubuntu2004:/root/debbuild ubuntu_20.04_build 8 Ubuntu 20.04"
                        //sh "podman run -it --rm -v /nfs/ubuntu2004:/root/debbuild ubuntu_20.04_build 10 Ubuntu 20.04 1.4"
                        sh "podman run -it --rm -v /nfs/ubuntu2004:/root/debbuild ubuntu_20.04_build 12 Ubuntu 20.04"
                    }
                    post {
                        always {
                ...
                stage('build_x86_64_packages_RedHat_8') {
                    ...
                    steps {
                        ...
                        //sh "podman run -it --rm -v /nfs/el8:/root/rpmbuild rockylinux/rockylinux:8 /bin/bash -c 'dnf install epel-release -y; dnf install dnf-plugins-core -y; dnf config-manager --set-enabled powertools; dnf install -y /root/rpmbuild/RPMS/noarch/*.rpm /root/rpmbuild/RPMS/x86_64/*.rpm'"
                        //sh "podman run -it --rm -v /nfs/el8:/root/rpmbuild rockylinux/rockylinux:8 /bin/bash -c 'dnf install -y git ; mkdir /infra; git clone https://github.com/oxedions/infrastructure.git /infra ; chmod +x /infra/auto_builder.sh ; auto_builder.sh 0 RedHat 8 ; dnf install -y /root/rpmbuild/RPMS/noarch/*.rpm /root/rpmbuild/RPMS/x86_64/*.rpm'"
                ...
                stage('build_x86_64_packages_RedHat_7') {
                    ...
                    steps {
                        ...
                        sh "podman run -it --rm -v /nfs/el7:/root/rpmbuild centos_7_build 1 RedHat 7"
                        sh "podman run -it --rm -v /nfs/el7:/root/rpmbuild centos_7_build 2 RedHat 7"
                        sh "podman run -it --rm -v /nfs/el7:/root/rpmbuild centos_7_build 3 RedHat 7"
                        sh "podman run -it --rm -v /nfs/el7:/root/rpmbuild centos_7_build 4 RedHat 7"
                        sh "podman run -it --rm -v /nfs/el7:/root/rpmbuild centos_7_build 5 RedHat 7"
                        sh "podman run -it --rm -v /nfs/el7:/root/rpmbuild centos_7_build 8 RedHat 7"
                        //sh "podman run -it --rm -v /nfs/el7:/root/rpmbuild centos_7_build 10 RedHat 7 1.4"
                    }
                    post {
                        always {
